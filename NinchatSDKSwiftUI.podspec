...
Pod::Spec.new do |s|
  s.name         = "NinchatSDKSwiftUI"
  s.version      = "0.4.5"
  s.summary      = "iOS SDK for Ninchat, Swift version with SwiftUI"
  ...
  s.subspec "SDKSwiftUI" do |ss|
    ss.source_files  = "NinchatSDKSwift/**/*.{swift}", "NinchatSDKSwiftUI/**/*.{swift}"
    ss.resource_bundles = {
